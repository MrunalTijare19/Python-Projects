...
title = Label(root, text="Number to Words converter",
              fg="Black", font=("Arial", 25, 'bold','underline')).place(x=150, y=10)
...
num_entry_lable = Label(root, text="Enter a number:",
               fg="Black", font=("Arial", 15, 'bold')).place(x=50, y=194)
num_entry = Entry(root,textvariable=num, width=30).place(x=220, y=200)



btn = Button(master=root, text="calculate",fg="Red", font=("Arial", 10, 'bold')
